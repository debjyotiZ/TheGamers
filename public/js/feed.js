...
var responseJSON = JSON.parse(xmlhttprequest.responseText);*/
   ...
   var input = new sap.m.FeedInput({post: function(oEvent){
 var sValue = oEvent.getParameter("value");
    ...
    bindFeedListData(oJsonModel.getData(), oFeedListItemTemplate, oFeedList);
   },icon:"images/profile_img40x40.jpg"}).addStyleClass("feed");
